...
const hero = "https://picsum.photos/seed/freelaflow-hero/1920/1080";
  ...
  return (
    <div className="page">
      <header className="hero full-bleed" style={{ "--hero": `url(${hero})` } as CSSProperties}>
        <nav className="nav"><p className="brand">FreelaFlow</p><a className="btn btn-ghost" href="#mvp">MVP</a></nav>
        <div className="hero-content">
          <p className="eyebrow">crm</p>
          <h1>CRM e operacao comercial para freelancers e micro-agencias.</h1>
          <p className="lead">Freelancers perdem receita por falta de processo comercial e operacional.</p>
      ...
      <main className="shell">
        ...
        <section className="section split" data-reveal>
          ...
          <article><p className="label">Produto</p><h2>Plano mensal com trial de 14 dias.</h2><p className="lead" style={{ color: "var(--muted)" }}>Base pronta para evoluir com autenticacao, banco e analytics.</p></article>
        </section>
      ...
      <footer className="footer"><p>FreelaFlow</p><p>{new Date().getFullYear()} - Projeto com padrao senior.</p></footer>
    </div>
  );
}
