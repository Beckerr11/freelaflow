...
const projectProfile = {
  ...
  "name": "FreelaFlow",
  "slug": "freelaflow",
  "tagline": "Pipeline comercial e operacional para freelancers em crescimento.",
  "vertical": "freelance-crm",
  "entity": {
    "singular": "lead",
    "plural": "leads"
  },
  "copy": {
    "titleLabel": "Nome da oportunidade",
    "detailsLabel": "Resumo da negociacao",
    "createButton": "Criar lead",
    "workspaceTitle": "Pipeline comercial em tempo real",
    "workspaceDescription": "Controle oportunidades ativas sem perder prazo de resposta ou follow-up."
  },
  "mvp": [
    "Gestao de leads por prioridade e etapa do funil.",
    "Organizacao de follow-up com contexto comercial.",
    "Painel de execucao para fechamento de propostas.",
    "Visao operacional para reduzir perda de oportunidades."
  ],
  "workflow": [
    "Cadastrar lead com contexto de negocio.",
    "Atualizar etapa e prioridade do atendimento.",
    "Concluir negociacao e registrar resultado final."
  ],
  "seedItems": [
    {
      "title": "Landing page para clinica odontologica",
      "details": "Cliente pediu proposta com prazo de 12 dias e checkout simples.",
      "priority": "high",
      "status": "open"
    },
    {
      "title": "Sistema interno para loja de bairro",
      "details": "Escopo inclui dashboard de estoque e relatorio mensal por categoria.",
      "priority": "medium",
      "status": "open"
    },
    {
      "title": "Site institucional para escritorio contabil",
      "details": "Contrato fechado e kickoff agendado para proxima segunda-feira.",
      "priority": "low",
      "status": "done"
    }
  ]
